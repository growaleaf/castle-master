...
// Copyright (c) 2015 The castle developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("castle-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("castle-smsg-pow"); // Make this thread recognisable
