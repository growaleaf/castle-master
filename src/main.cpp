...
unsigned int nStakeMinAge       = 6 * 60 * 60;			// 4 hour
unsigned int nStakeMaxAge       = 8 * 24 * 60 * 60;	// 30 days
...
const string strMessageMagic = "castle Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "castle", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Castle built!!!";
        CTransaction txNew;
        txNew.nTime = 1508550734;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1508550734;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1079257 : 1079257;
...
//        assert(block.hashMerkleRoot == uint256("0xeb42ae0324ea968b5cdcd959104fc3b1cd93c45e25ba5be25b5e55deaf21254c"));
        assert(block.hashMerkleRoot == uint256("0x513ea5dfd96b37760df0f3367cce98fac09251a8ed3a0297989ae59710157c94"));
...
unsigned char pchMessageStart[4] = { 0x91, 0x35, 0xe1, 0x7d };
